#!/Users/shinya.nishimoto/.anyenv/envs/plenv/versions/5.19.6/bin/perl5.19.6 -w

eval 'exec /Users/shinya.nishimoto/.anyenv/envs/plenv/versions/5.19.6/bin/perl5.19.6 -w -S $0 ${1+"$@"}'
